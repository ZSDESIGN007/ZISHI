#!/usr/bin/python2
#coding=utf-8
#The Credit For This Code Goes To ZISHI SHAH
...
\033[1;91m [⚡\033[1;97mAuthor Name: ZISHI SHAH     ⚡\033[1;91m]
\033[1;91m [⚡\033[1;97mYutube Chnl: ZS DESIGN ⚡\033[1;91m]
\033[1;91m [⚡       \033[1;97mFrom: Pakistan      ⚡\033[1;91m]
\033[1;95m«-_-_-_-_-_-_-_-_-\033[1;91mZISHI\033[1;95m-_-_-_-_-_-_-_-_-»
"""
...
\033[1;95m«-_-_-_-_-_-_-_-_-\033[1;91mZISHI\033[1;95m-_-_-_-_-_-_-_-_-»
 """
CorrectUsername = "ZISHI SHAH"
CorrectPassword = "ZS DESIGN"
...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
        ...
        if (password == CorrectPassword):
            print "Logged in successfully as " + username #Dev:ZISHI SHAH
	    time.sleep(2)
            loop = 'false'
        else:
            print "\033[1;93mWrong Password"
            os.system('xdg-open https://www.youtube.com/channel/UCefCiQIMzv9aSHRuEW6GTPw')
    else:
...
def menu():
	...
	try:
		...
		keluar()
	os.system("clear") #Dev:ZISHI_SHAH
	print logo
	...
	print "\033[1;97m[3]\x1b[1;92mSubscribe ZS DESIGN Youtube Channel " 
...
def pilih_super():
	...
	p.map(main, id)
#Dev:ZISHI_SHAH
        print "\033[1;95m«-_-_-_-_-_-_-_-_-\033[1;91mZISHI\033[1;95m-_-_-_-_-_-_-_-_-»"
